...
export const getNamedUrl = (iconName: string, iconCategory: string): string =>
  `https://cdn.jsdelivr.net/gh/MM25Zamanian/Erbium/assets/iconsax-svg/${iconCategory}/${iconName}.svg`;
...
export type iconsaxNames =
  ...
  | 'Crypto/google'
  | 'Crypto/harmony-(one)'
  | 'Crypto/hedera-hashgraph-(hbar)'
  | 'Crypto/hex-(hex)'
  | 'Crypto/html-3'
  | 'Crypto/html-5'
  | 'Crypto/huobi-token-(ht)'
  | 'Crypto/icon-(icx)'
  | 'Crypto/icon-1'
  | 'Crypto/icon'
  | 'Crypto/illustrator'
